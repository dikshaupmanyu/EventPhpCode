              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   ...
                   <!--  <li class="nav-header">Master List</li>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=subcategory" class="nav-link nav-subcategory">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Desk/Designation List
                        </p>
                      </a>
                    </li>
                     <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=filetype" class="nav-link nav-filetype">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          File Type
                        </p>
                     ...
                     <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=fileMechanism" class="nav-link nav-fileMechanism">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          File Mechanism
                        </p>
