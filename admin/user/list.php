...
<!-- 				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" ><i class="fa fa-file-export" style="color: black;"></i> Export PDF</a>
 -->
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo $row['subdepartment'] ?></b></td>
